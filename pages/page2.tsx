...
export default function Page2() {
  return (
    <main dir="rtl" style={{ textAlign: "center", padding: "16px" }}>
      ...
      >
{`וְרַק הַפִּיל הַקָּטָן, עֲדַיִין חִיפֵּשׂ אֶת הַכִּישָּׁרוֹן בּוֹ נִיחָן.
...
חִיְּיכוּ הַהוֹרִים וְאָמְרוּ: "כְּשֶׁתִּהְיֶה גָּדוֹל, תַּעֲשֶׂה כֹּל מָה שֶׁאַתָּה יָכוֹל, אֲבָל עַד אָז,
